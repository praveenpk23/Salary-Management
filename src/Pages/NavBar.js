...
const NavBar = () => {
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="md" fixed="top" style={{marginBottom:"50px"}}>
      <Navbar.Brand as={Link} to="/" style={{marginLeft:"20px"}}>RVR Bricks</Navbar.Brand>
      <Navbar.Toggle aria-controls="navbar-nav" />
      <Navbar.Collapse id="navbar-nav">
        <Nav className="mr-auto">
          <Nav.Link defaultChecked as={Link} to="/" active={location.pathname === '/'} style={{marginLeft:"80px"}}>
            Add Work
          </Nav.Link>
